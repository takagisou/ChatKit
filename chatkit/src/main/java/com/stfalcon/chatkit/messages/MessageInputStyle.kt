...
internal class MessageInputStyle private constructor(context: Context, attrs: AttributeSet) : Style(context, attrs) {
    ...
    private var attachmentButtonBackground = 0
    private var attachmentButtonDefaultBgColor = 0
    private var attachmentButtonDefaultBgPressedColor = 0
    private var attachmentButtonDefaultBgDisabledColor = 0
    private var attachmentButtonIcon = 0
    private var attachmentButtonDefaultIconColor = 0
    private var attachmentButtonDefaultIconPressedColor = 0
    private var attachmentButtonDefaultIconDisabledColor = 0
    ...
    private var inputButtonDefaultBgColor = 0
    private var inputButtonDefaultBgPressedColor = 0
    private var inputButtonDefaultBgDisabledColor = 0
    private var inputButtonIcon = 0
    private var inputButtonDefaultIconColor = 0
    private var inputButtonDefaultIconPressedColor = 0
    private var inputButtonDefaultIconDisabledColor = 0
    ...
    private fun getSelector(@ColorInt normalColor: Int, @ColorInt pressedColor: Int,
        ...
        DrawableCompat.setTintList(
                drawable,
                ColorStateList(arrayOf(intArrayOf(android.R.attr.state_enabled, -android.R.attr.state_pressed), intArrayOf(android.R.attr.state_enabled, android.R.attr.state_pressed), intArrayOf(-android.R.attr.state_enabled)), intArrayOf(normalColor, pressedColor, disabledColor)))
        return drawable
    }
    ...
    companion object {
        ...
        private const val DEFAULT_DELAY_TYPING_STATUS = 1500
        @JvmStatic
